...
// Pelanggan private endpoints (butuh login)
Route::middleware('auth:pelanggan-api')->group(function () {
    ...
    // Pelanggan bisa view alat & kategori (read-only)
    ...
    // Pelanggan create & manage penyewaan (rental)
    ...
    // Pelanggan manage penyewaan detail (items dalam rental)
    ...
    // Pelanggan manage data pribadi (KTP/SIM)
